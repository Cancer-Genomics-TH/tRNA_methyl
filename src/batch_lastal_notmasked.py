...
"""
mapping NOT fqgrep masked fastq files to GRCh38_plus_tRNAs
...
input_dir = "./fq_inputs"
out_dir = "./map_results/not_masked"

# not masked input files
input_fn_pattern_1 = "*clump_opt_dedup.fastp.fq.gz"
...
for pattern in patterns:
    for fastq_fn in glob.glob(f"{input_dir}/{pattern}"):
        ...
        out_maf_fn = f"{out_dir}/{fastq_fn_base}.lastal.hg39-revtRNAs.maf.gz"
